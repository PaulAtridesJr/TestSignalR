...
#include <iostream>
#include <sstream>
#include "include/signalrclient/hub_connection.h"
#include "include/signalrclient/hub_connection_builder.h"
#include "include/signalrclient/log_writer.h"
#include <future>
#include "include/signalrclient/signalr_value.h"
...
{
    // std::string("c++"),
    //std::vector<signalr::value> arr{ signalr::value((double)1), signalr::value((double)2), signalr::value((double)3) };
    //signalr::value args(arr);

    //_connection.invoke("SendSetXXXXEnabledCommand", args, ...);
...
void chat()
{
    signalr::hub_connection connection = signalr::hub_connection_builder::create("http://localhost:9123/Test")
